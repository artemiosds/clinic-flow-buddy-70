        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-4 md:gap-6">
              <img src={docConfig?.logoEsquerda || logoSmsFallback} alt="Logo" className="w-20 h-20 md:w-24 md:h-24 rounded-2xl object-cover shadow-2xl border-4 border-white/20" />
              <div>
                <h1 className="text-2xl md:text-4xl font-extrabold font-display tracking-tight leading-tight">
                  {docConfig?.linha1 || 'Agendamento Online'}
                </h1>
                <p className="opacity-90 mt-1 font-medium md:text-lg">
                  {docConfig?.linha2 || 'SMS Oriximiná — Solicite sua consulta'}
                </p>
              </div>
            </div>
          </div>
