...
const DEFAULT_SECTIONS: ProntuarioSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'f_anamnese', key: 'anamnese', label: 'Anamnese / HD', type: 'textarea', required: false, enabled: true, isBuiltin: true, order: 1 },
      ...
      { id: 'f_conduta', key: 'conduta', label: 'Conduta / Diagnóstico Funcional', type: 'textarea', required: false, enabled: true, isBuiltin: true, order: 5 },
      { id: 'f_soap_s', key: 'soap_subjetivo', label: 'SOAP — Subjetivo', type: 'textarea', required: false, enabled: true, isBuiltin: true, order: 6 },
      { id: 'f_soap_o', key: 'soap_objetivo', label: 'SOAP — Objetivo', type: 'textarea', required: false, enabled: true, isBuiltin: true, order: 7 },
      { id: 'f_soap_a', key: 'soap_avaliacao', label: 'SOAP — Avaliação', type: 'textarea', required: false, enabled: true, isBuiltin: true, order: 8 },
      { id: 'f_soap_p', key: 'soap_plano', label: 'SOAP — Plano', type: 'textarea', required: false, enabled: true, isBuiltin: true, order: 9 },
      { id: 'f_evolucao', key: 'evolucao', label: 'Evolução Clínica', type: 'textarea', required: false, enabled: true, isBuiltin: true, order: 10 },
  ...
  },
  {
    ...
    order: 2,
    fields: [
      { id: 'f_tema_grupo', key: 'custom_tema_grupo', label: 'Tema do Grupo', type: 'text', required: false, enabled: true, isBuiltin: false, order: 0 },
      { id: 'f_tipo_atividade', key: 'custom_tipo_atividade', label: 'Tipo de Atividade', type: 'text', required: false, enabled: true, isBuiltin: false, order: 1 },
      { id: 'f_evolucao_grupo', key: 'custom_evolucao_grupo', label: 'Evolução / Participação', type: 'textarea', required: false, enabled: true, isBuiltin: false, order: 2 },
    ],
    type: 'standard',
