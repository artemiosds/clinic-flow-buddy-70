...
BEGIN
  ...
  -- Resolve current staff user id (text) when restricting to own professional
...
GRANT EXECUTE ON FUNCTION public.get_treatment_cycles_paginated(integer, integer, text, text, text, text, boolean) TO authenticated;